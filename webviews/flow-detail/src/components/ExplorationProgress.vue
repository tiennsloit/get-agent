  ...
  <div class="flex w-80 items-start space-x-2 text-xs mt-4 mb-1">
    <div class="flex-1 bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/20 rounded-lg p-4">
      <div class="space-y-3">
        ...
        <div class="flex items-center justify-between mb-1 cursor-pointer select-none"
          ...
          <div class="flex items-center space-x-2">
            ...
            <svg class="w-4 h-4 text-blue-400 transition-transform duration-200" :class="{ 'rotate-180': isExpanded }"
                ...
                <div class="flex items-center space-x-2">
                  <div class="flex-1 bg-white/5 rounded-full h-1.5 overflow-hidden">
                    <div class="bg-blue-400 h-full transition-all duration-300"
                      :style="{ width: `${Math.ceil(score * 100)}%` }">
                    </div>
                  </div>
